...
public class C1GreedyKnapsack {
    ...
    double calc(File source) throws FileNotFoundException {
        ...
        for (int i = 0, emptyW = W; i < items.length && emptyW > 0; i++) {
            int weight = (items[i].weight > emptyW) ? emptyW : items[i].weight;
            result += (double) (items[i].cost) / items[i].weight * weight;
            emptyW -= weight;
        }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f=new File(root+"by/it/sc02_morning/opanovich/lesson10/greedyKnapsack.txt");

...
public class Testing {
    ...
    public void A() throws Exception {
        ...
        InputStream stream = new FileInputStream(root + "by/it/sc02_morning/opanovich/lesson11/dataA.txt");
    ...
    public void C() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/sc02_morning/opanovich/lesson11/dataC.txt");

...
class TaskA2 {
    public static void main(String[] args) {
        String a = "Ты меня не любишь, не жалеешь, ";
        String b = "Разве я немного не красив?";
        String c = "Не смотря в лицо, от старости млеешь,";
        String d = "Мне на плечи руки опустив.";
        String e = "Ты меня не любишь, не жалеешь ";
